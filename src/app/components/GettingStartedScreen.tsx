...
export function GettingStartedScreen(): ReactElement {
  return (
    <div className="fixed inset-0 z-100 bg-mantle flex justify-center items-center overflow-y-auto py-10">
      <div className="w-full max-w-md flex flex-col gap-6 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-3 motion-safe:duration-500">
        <div>
          <div className="font-display text-lg font-bold tracking-tight text-mauve mb-3">
            Squeal
          </div>
        ...
        <p className="flex items-center gap-2 text-xs text-subtext-0">
