    ...
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          ...
          'bg-panel text-text border-border shadow-[0_8px_24px_rgba(0,0,0,0.14)] animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-max max-w-[min(20rem,calc(100vw-2rem))] origin-(--radix-popover-content-transform-origin) rounded-md border p-3',
          className
        )}
        {...props}
      />
